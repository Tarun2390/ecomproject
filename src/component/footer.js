    ...
    return (
      ...
      <div className="footer">
			...
			<div className="w3_footer_grids">
				<div className="col-md-3 w3_footer_grid">
					...
					<ul className="address">
						<li><i className="glyphicon glyphicon-map-marker" aria-hidden="true"></i>1234k Avenue, 4th block, <span>Shahkot City.</span></li>
		...
		<div className="footer-copy">
			...
			<div className="container">
				<p>© 2023 Super Market. All rights reserved | Design by <a href="http://w3layouts.com/">Tarun</a></p>
			</div>
		</div>
