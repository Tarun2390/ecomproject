...
app.post("/api/addproduct",upload.single('pic'),async(req,res)=>
{
 ...
 const newrecord= new addproductmodel({category_id:req.body.category_id,Subcategory_id:req.body.subcategory_id,Product_name:req.body.productname,Rate:req.body.rate,Discount:req.body.discount,Stock:req.body.stock,Discription:req.body.discription,Featured:req.body.featured,Product_pic:picname,Addedon:new Date})
...
app.put("/api/updateproduct/:pid",upload.single('pic'),async(req,res)=>
{
 ...
 const updateresult= await addproductmodel.updateOne({_id:req.params.pid},{$set:{Product_name:req.body.productname,Rate:req.body.rate,Discount:req.body.discount,Stock:req.body.stock,Discription:req.body.discription,Featured:req.body.featured,Product_pic:picname }}) 
...
var cartSchema = new mongoose.Schema({prodid:String,name:String,rate:Number,qty:Number,tcost:Number,prodpic:String,stock:String,username:String},{versionKey: false})
...
//update cart
// app.get("/api/updatecart/:id",async(req,res)=>
// {
//     const result = await  cartModel.findOne({_id:req.params.id})
//     if(result)
//     {
//         res.send({statuscode:1})
//     }
